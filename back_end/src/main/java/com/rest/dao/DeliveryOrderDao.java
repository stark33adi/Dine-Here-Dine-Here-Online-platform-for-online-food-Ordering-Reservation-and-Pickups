...
public interface DeliveryOrderDao {
    ...
    public List<LinkedHashMap<String, Object>> getNotTakenOrder(HashMap<String, Object> param);
    ...
    public LinkedHashMap<String, Object> getTip(HashMap<String, Object> param);
