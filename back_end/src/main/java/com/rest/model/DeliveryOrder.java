...
public class DeliveryOrder {
    ...
    public String toString() {
        return "DeliveryOrder{" + "orderId=" + orderId + ", orderNumber='" + orderNumber + '\'' + ", orderState='" + orderState + '\'' + ", customerEmail='" + customerEmail + '\'' + ", restaurantEmail='" + restaurantEmail + '\'' + ", deliveryGuyEmail='" + deliveryGuyEmail + '\'' + ", totalPrice='" + totalPrice + '\'' + ", note='" + note + '\'' + ", dishId=" + dishId + ", dishCount=" + dishCount + ", genDateFromOrderList='" + genDateFromOrderList + '\'' + ", genDateFromOrderItem='" + genDateFromOrderItem + '\'' + ", genDateFromOrderStateLog='" + genDateFromOrderStateLog + '\'' + '}';
    }
}
