...
public class SpringPickupOrderServiceTest {
    ...
    public void testGet() {
        ...
        HashMap<String, Object> order = pickupOrderService.getOrderByCustomerEmail(param);
    ...
    public void testAddNewOrder() throws IllegalAccessException {
        ...
        System.out.println(pickupOrderService.addNewOrder(param));
    ...
    public void testGetOrderByRestaurantEmail() {
        ...
        System.out.println(pickupOrderService.getOrderByRestaurantEmail(param));
    }
